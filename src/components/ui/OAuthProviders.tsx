    ...
    <div class="mt-6">
      ...
      <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
        <button
          ...
          class={cn(
            "flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-background border border-border rounded-xl hover:cursor-pointer",
        ...
        >
          <Show when={loading() === 'google'} fallback={<ImGoogle class="w-4 h-4" />}>
            <IoReloadOutline class="w-5 h-5 animate-spin text-muted-foreground" />
          </Show>
          Google
        </button>
