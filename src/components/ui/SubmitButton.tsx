...
export const SubmitButton: Component<SubmitButtonProps> = (props) => {
  ...
  return (
    <button
      ...
      class={cn(
        "relative w-full overflow-hidden bg-primary text-primary-foreground font-medium py-3.5 px-4 rounded-xl",
        "hover:bg-primary-hover active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none",
    ...
    >
      {local.loading ? (
        <>
          <svg class="animate-spin h-5 w-5 text-primary-foreground/70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
